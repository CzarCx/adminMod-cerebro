  ...
  return (
    <div className="space-y-16">
      <header className="text-center animate-in fade-in slide-in-from-top-10 duration-500">
        ...
        <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">Una solución integral para el seguimiento, reporte y análisis del etiquetado en su almacén.</p>
      </header>
